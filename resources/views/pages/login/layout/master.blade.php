...
{{--                    <h1 class="mb-0"> <b>Mercado</b> Livre--}}
{{--                    </h1>--}}
{{--                </a>--}}
{{--            </div>--}}
{{--            <div class="card-body login-card-body">--}}
{{--                <p class="login-box-msg">Fazer sessão de login</p>--}}
{{--                <form action="{{ route('login.store') }}" method="post">--}}
{{--                    @csrf--}}
{{--                    <div class="input-group mb-1">--}}
{{--                        <div class="form-floating"> <input id="loginEmail" type="email" name="email" value="admin@admin.com" class="form-control" placeholder=""> <label for="loginEmail">Email</label> </div>--}}
{{--                        <div class="input-group-text"> <span class="bi bi-envelope"></span> </div>--}}
{{--                    </div>--}}
{{--                    <div class="input-group mb-1">--}}
{{--                        <div class="form-floating"> <input id="loginPassword" type="password" class="form-control" name="password" value="123456" placeholder=""> <label for="loginPassword">Senha</label> </div>--}}
{{--                        <div class="input-group-text"> <span class="bi bi-lock-fill"></span> </div>--}}
{{--                    </div>--}}
{{--                    <div class="row">--}}
{{--                        <div class="col-8 d-inline-flex align-items-center">--}}
{{--                            <div class="form-check"> <input class="form-check-input" type="checkbox" name="remember" id="flexCheckDefault">--}}
